    ...
    */
    ...
    fetch("https://dataserverdaw.herokuapp.com/libros/xml")
        ...
        .then(data => {
            ...
            xml.querySelectorAll('bookstore > book')
            querySelector('div.cards').querySelector('title').textContent.querySelector('isbn').textContent.querySelector('shortDescription').innerHTML += document.querySelectorAll("div.card").forEach(carta => {
                animarCartas(carta)
            });
        });
    /*Fin*/
